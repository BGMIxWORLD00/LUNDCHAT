...
bot = telebot.TeleBot('7340652145:AAEg3JuwjSq6zmEPc6NgFg-wvrBz7fo4AD0')
# Admin user IDs
admin_id = {"6987108806"}
    ...
    if user_id in users:
        ...
        if len(command) == 4:
            ...
            try:
                ...
                time = int(command[3])
                if time > 400:
                    response = "⚠️𝐄𝐑𝐑𝐎𝐑:400 𝐒𝐄 𝐓𝐇𝐎𝐃𝐀 𝐊𝐀𝐌 𝐓𝐈𝐌𝐄 𝐃𝐀𝐀𝐋 𝐆𝐀𝐍𝐃𝐔."
                else: 
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 🔥NANCY 𝐂𝐇𝐔𝐃𝐀𝐈 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥\n\n🎯𝐓𝐀𝐑𝐆𝐄𝐓: {target}\n🚪𝐏𝐎𝐑𝐓: {port}\n⏳𝐓𝐢𝐌𝐄: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐄𝐓𝐇𝐎𝐃: CRISPY KI BLACK 𝐏𝐔𝐒𝐒𝐘🥵"
    bot.reply_to(message, response)
